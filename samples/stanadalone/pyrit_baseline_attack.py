#!/usr/bin/env python3
"""Standalone Baseline attack runner with colored logging and local-only prompt source."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Standalone baseline attack runner.")
    ...
    try:
        logger.info("Starting standalone baseline run")
