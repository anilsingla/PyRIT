...
from pyrit.orchestrator import RedTeamingAttack
from pyrit.score import get_all_scorers

def run_redteam_attack(memory, args):
    attack_runner = RedTeamingAttack(memory=memory)
